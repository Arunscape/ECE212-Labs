...
\section{Testing}
  ...
  \subsection{Part B}
    ...
    through our code, and monitor relevant memory addresses and registers. We
          ...
          \begin{enumerate}
            \item Register Indirect With Offset
              \begin{enumerate}
                ...
                \item Doesn't modify the address which the address register points to
              \end{enumerate}
            \item Indexed Register Indirect
            \begin{enumerate}
              \item Can use a data register to specify offset
              \item Doesn't modify the address which the address register points to
            \end{enumerate}
