...
\section{Design}
  ...
  \textbf{from the last lab}
    ...
    \begin{figure}[H]
      ...
      \caption{\textbf{need a better caption}Layout of data}
    \end{figure}
...
\newpage
  ...
  \subsection{Part A Flowchart Diagram}
    \vspace{2cm}
    \noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio]{partaflowchart.jpg}}
\newpage
