...
\textbf{TODO
  ...
  DESCRIBE THE BOARD A LITTLE BIT

  DESCRIBE THE LANGUAGE A BIT
  ...
  one computer to develop code in tandem.  The partners are divided into the Driver and the Navigator.
